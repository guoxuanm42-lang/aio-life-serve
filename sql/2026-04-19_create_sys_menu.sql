...
(1502, 1500, 'videoWatch', '/my-hub/videoWatch', 'my-hub/videoWatch/index', NULL,
 ...
 NULL, 1, 1, 0),
(1503, 0, 'think', '/think/all', 'my-hub/think/list', NULL,
 JSON_OBJECT('icon','mdi:lightbulb-on-outline','title','闪念','order',3,'backTop',false,'keepAlive',true),
 NULL, 3, 1, 0),
(15030, 1503, 'thinkAll', '/think/all-hidden', 'my-hub/think/list', NULL,
 JSON_OBJECT('title','全部','keepAlive',true,'backTop',false),
 NULL, 0, 0, 0),
(15031, 1503, 'thinkWork', '/think/work', 'my-hub/think/list', NULL,
 JSON_OBJECT('title','工作','keepAlive',true,'backTop',false),
 NULL, 1, 0, 0),
(15032, 1503, 'thinkLife', '/think/life', 'my-hub/think/list', NULL,
 JSON_OBJECT('title','生活','keepAlive',true,'backTop',false),
 NULL, 2, 0, 0),
(15037, 1503, 'thinkHealthy', '/think/healthy', 'my-hub/think/list', NULL,
 JSON_OBJECT('title','健康','keepAlive',true,'backTop',false),
 NULL, 3, 0, 0),
(15033, 1503, 'thinkStudy', '/think/study', 'my-hub/think/list', NULL,
 JSON_OBJECT('title','学习','keepAlive',true,'backTop',false),
 NULL, 4, 0, 0),
(15034, 1503, 'thinkSocial', '/think/social', 'my-hub/think/list', NULL,
 JSON_OBJECT('title','社交','keepAlive',true,'backTop',false),
 NULL, 5, 0, 0),
(15035, 1503, 'thinkCreation', '/think/creation', 'my-hub/think/list', NULL,
 JSON_OBJECT('title','创作','keepAlive',true,'backTop',false),
 NULL, 6, 0, 0),
(15038, 1503, 'thinkAioLife', '/think/aio-life', 'my-hub/think/list', NULL,
 JSON_OBJECT('title','AIO-LIFE开发','keepAlive',true,'backTop',false),
 NULL, 7, 0, 0),
(15036, 1503, 'thinkTravel', '/think/travel', 'my-hub/think/list', NULL,
 JSON_OBJECT('title','旅行','keepAlive',true,'backTop',false),
 NULL, 8, 0, 0),
